...
if __name__ == '__main__':
    ...
    true_segments = acquisition.comp_segments(all_points, points, 500, image_name)
    acquisition.draw_segments(true_segments, image_name)                       # debug function: draw lines between points
